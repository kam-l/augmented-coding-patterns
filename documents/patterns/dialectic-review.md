...
This is not Feedback Flip — Feedback Flip refocuses one agent from producing to critiquing, and stays the right tool for routine diffs. This puts the evaluation itself on trial.
...
One run costs about 200k tokens — two openings, two rebuttals, a judgment. Spend it where being wrong is expensive; a routine diff does not need a trial.
